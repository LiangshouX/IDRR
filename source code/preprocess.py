...
from raw.pdtb2.pdtb2 import CorpusReader
import argparse
import os
import sys

top_senses = {'Temporal', 'Comparison', 'Contingency', 'Expansion'}
selected_second_senses = {'Temporal.Asynchronous', 'Temporal.Synchrony', 'Contingency.Cause',
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', dest='splitting', choices=[1, 2], type=int, default='1')
    A = parser.parse_args()
    preprocess()
